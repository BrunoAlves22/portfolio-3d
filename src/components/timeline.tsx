...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <h2 className="text-lg md:text-4xl mb-4 text-white max-w-4xl font-poppins">
        Minhas Experiências
      </h2>
      ...
      <div ref={ref} className="relative pb-20">
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full text-white font-dm-sans text-center">
